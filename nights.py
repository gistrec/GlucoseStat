...
# ночь считалась натощак. Три часа — компромисс, и стоит назвать обе его
# стороны. Быстрый аналог живёт три-пять часов, так что к трём ночи хвост
# ужина ещё не нулевой; но при четырёх часах правило требует ужина не позже
# одиннадцати вечера, и на живом журнале из семи ночей проходили две — медиана
# по такой выборке не публикуется вовсе, то есть строгость съедала всю фичу.
# Три часа пропускают обычный ужин до полуночи и по-прежнему отсекают ночную
# еду: перекус в час ночи оставляет до трёх всего два часа.
FASTING_GAP = timedelta(hours=3)
